...
/**
 * Simple node that implements the Root-Operator.
 *
 * @author Daniel Wilfing
 * @since 1.0
 */
public class SquareRootNode extends FunctionalGPGraphNode<Double> {
    ...
    public Double calculateValue() {
        return Math.pow((Double) getChildNodes().get(0).execute(), 1 / (Double) getChildNodes().get(1).execute());
    }
