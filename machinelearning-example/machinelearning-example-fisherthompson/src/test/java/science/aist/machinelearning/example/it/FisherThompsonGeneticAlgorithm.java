 ...
 * @since 1.0
 */
public class FisherThompsonGeneticAlgorithm {
    ...
    public void setup() {
        ...
        geneticAlgorithm.setPopulationSize(1000);
        geneticAlgorithm.setMaximumGenerations(1000);
        geneticAlgorithm.setElites(10);
        geneticAlgorithm.setMutationProbability(0.25);
    }
