...
/**
 * Fisher thompson test a heuristic-graph that implements a genetic algorithm.
 *
 * @author Daniel Wilfing
 * @since 1.0
 */
public class FisherThompsonGeneticAlgorithmByGP {
    ...
    private final ConstantDoubleNode numberNode6 = new ConstantDoubleNode();
    //new generation
    private final ConstantDoubleNode numberNode2 = new ConstantDoubleNode();
    private final ConstantDoubleNode numberNode7 = new ConstantDoubleNode();
    //start population
    private final ConstantDoubleNode numberNode9 = new ConstantDoubleNode();
    /**
    ...
    public void setup() {
        ...
        crossoverNode.setCrossover(crossover);
        ...
        forCollectionNode3.addChildNode(numberNode9);
    ...
    private void fisherThompsonNxN(int jobs, int machines) {
        ...
        System.out.println("Genetic: " + solution1.getQuality());
        System.out.println("Evaluations: " + FisherThompsonCachet.runs);
        System.out.println("Mutations: " + FisherThompsonMutator.runs);
        System.out.println("Crossovers: " + OnePointCrossover.runs);
