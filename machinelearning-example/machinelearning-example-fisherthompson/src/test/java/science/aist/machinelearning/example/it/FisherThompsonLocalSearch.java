 ...
 * @since 1.0
 */
public class FisherThompsonLocalSearch {
    ...
    public void setup() {
        ...
        iterativeLocalSearchAlgorithm.setMutator(mutator2);
    ...
    private void fisherThompsonNxN(int jobs, int machines) {
        ...
        Solution<List<Integer>, Integer> solution1 = iterativeLocalSearchAlgorithm.solve(problem);
        long endTime = System.currentTimeMillis();

        System.out.println("Time spent: " + (endTime - startTime));

        evaluator.evaluateQuality(solution1);
        System.out.println("Iterative: " + solution1.getQuality());
